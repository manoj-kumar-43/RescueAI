      ...
      <div className="flex-1 relative bg-surface-container h-full w-full">
        ...
        {filteredHospitals.map(h => (
          <div
            ...
            style={{ top: h.markerPos.top, left: h.markerPos.left }}
        ...
        {/* Map Popup Template (Appears when marker is clicked) */}
        {selectedHospital && (
          <div 
            style={{ 
              top: `calc(${selectedHospital.markerPos.top} - 55px)`, 
              left: selectedHospital.markerPos.left 
            }}
        ...
        <div className="flex-1 overflow-y-auto p-4 md:p-stack-md flex flex-col gap-stack-md pb-24 md:pb-stack-md bg-surface-bright">
          {filteredHospitals.length > 0 ? (
            ...
            <div className="text-center py-8 text-on-surface-variant">
              No medical facilities match your search query or filter.
            </div>
          )}
        </div>
      </div>
